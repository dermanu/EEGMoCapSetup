...
public class LSLOutletTriggerEvent : MonoBehaviour
{
    /*
        ...
        */
    public string StreamName = "unity-mocap-study";
    ...
    {
        if (s== null || (s.Length == 0) || outlet == null)
        {
            Debug.LogError("Invalid sample or outlet is null");
            return;
        }
        Debug.Log("Pushed message to outlet: " + s);
        sample[0] = s;
